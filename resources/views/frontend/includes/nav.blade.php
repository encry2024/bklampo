                ...
                @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="{{ route('frontend.sale.daily') }}">Daily</li>
                            <li><a href="{{ route('frontend.sale.monthly') }}">Monthly</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="{{ route('frontend.user.request.create') }}">Create Request</a></li>
                            <li><a href="{{ route('frontend.user.request.index') }}">View Requests</a></li>
                        </ul>
                    </li>
